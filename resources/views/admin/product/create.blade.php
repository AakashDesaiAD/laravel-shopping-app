    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="px-5">
                    <form action="{{ route('admin.products.store') }}" method="POST" files=true enctype="multipart/form-data">
                        {{ method_field('POST') }}
                        @csrf
                          ...
                          <div class="form-group">
                            ...
                            <input name="price" type="number" class="form-control" id="desc" placeholder="Enter price">
                          </div>
